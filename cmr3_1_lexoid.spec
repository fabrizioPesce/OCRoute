...
a = Analysis(
    ...
    datas=[
        ...
        ('ocroute_icon.ico', '.'),
        ('C:/Users/donot/Desktop/Da tenere/OCRoute/venv/Lib/site-packages/lexoid', 'lexoid'),
        ('C:/Users/donot/Desktop/Da tenere/OCRoute/venv/Lib/site-packages/pypdfium2', 'pypdfium2'),
    ],
    hiddenimports=['paddleocr', 'paddle', 'paddleocr.tools', 'paddleocr.ppocr', 'ppstructure', 'cv2', 'reportlab', 'PIL', 'setuptools', 'requests', 'PIL.ImageDraw', 'PIL.ImageFont', 'shapely', 'pyclipper', 'skimage', 'skimage.morphology._skeletonize', 'skimage.draw', 'skimage.measure','skimage.filters', 'albumentations', 'albumentations.augmentations.transforms', 'albumentations.core.composition', 'lmdb', 'docx', 'lexoid.api',],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
